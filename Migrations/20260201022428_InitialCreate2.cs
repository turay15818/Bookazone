...
namespace Bookazone.Migrations
{
  ...
  /// <inheritdoc />
         ...
         protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        foreach (var r in roleIds)
        {
            migrationBuilder.InsertData(
                table: "Roles",
                schema: "profile",
                columns: new[] { "Id", "Name", "Slug", "DateCreated", "Active", "Deleted", "IsSystem" },
                values: new object[] { r.Id, r.Name, r.Id.ToString(), DateTime.UtcNow, true, false, false}
            );
        }
        ...
        foreach (var p in permissions)
        {
            migrationBuilder.InsertData(
                ...
                schema: "profile",
                columns: new[] { "Id", "Name", "Slug", "DateCreated", "Active", "Deleted", "IsSystem"},
                values: new object[] { p.Id, p.Key, p.Id.ToString(), DateTime.UtcNow, true, false, false}
            );
        }
        ...
        void AddRolePerm(string role, string permKey)
        {
            migrationBuilder.InsertData(
                ...
                schema: "profile",
                columns: new[] { "Id", "FkRoleId", "FkPermissionId", "DateCreated", "Active", "Deleted" },
                values: new object[]
                {
    ...
    protected override void Down(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.Sql("DELETE FROM \"RolePermission\";");
